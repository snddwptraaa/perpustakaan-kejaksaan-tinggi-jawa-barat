<div class="space-y-6">
    ...
    <div class="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
            ...
            <h1 class="mt-2 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Kategori & Bidang Hukum</h1>
        ...
        <div class="border-b border-stone-100 p-4 sm:p-5">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="text-xs font-medium text-slate-500">
                    Total: <span class="font-bold text-slate-800">{{ $categories->total() }}</span> kategori
                </div>
            </div>
        </div>
                        ...
                        <tr class="transition hover:bg-stone-50/70">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-kejati/10 text-kejati font-bold text-sm">
                                        {{ mb_substr($category->nama_kategori, 0, 1) }}
                                    </div>
    ...
    @if ($showForm)
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-category-title" role="dialog" aria-modal="true">
                    ...
                    <div class="bg-gradient-to-r from-kejati-dark to-kejati px-6 py-5 text-white">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <h3 class="mt-1.5 text-xl font-bold text-white" id="modal-category-title">
                                    {{ $editingId ? 'Edit Kategori Buku' : 'Tambah Kategori Buku Baru' }}
                                </h3>
                            </div>
